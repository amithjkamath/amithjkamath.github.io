...
[Here](https://tinyurl.com/template-matching-demo) is a simple UI that allows you to literally slide 'Waldo', our protagonist across a cluttered scene where it is otherwise hard to find him, and learn how the correlation matrix is computed to then locate where he is. 
