...
[Here](https://tinyurl.com/registration-demo) is a simple UI that allows you to modify each element of the affine transformation matrix, and observe how the image is deformed due to this change. This is meant to provide a practical understanding of these choices, for example, how rotation and translation are governed by separate parameters. 
